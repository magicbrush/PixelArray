...
function draw() {	
	...
	// 磁场作用：洛伦兹力
	if(renderValueFcns==="RenderValues_MagneticElectronic")
	{
...
function Init()
{
	...
	clickInteract = new ClickInteracter(
		12,3.5,0.24,
		createElectron0,
		createElectron1,
		createElectron2,
...
function mousePressed()
{
	...
	*/
	...
	if(mouseMode === "electron" && 
    	renderValueFcns === "RenderValues_MagneticElectronic")
	{
		clickInteract.mousePressed();
	}
